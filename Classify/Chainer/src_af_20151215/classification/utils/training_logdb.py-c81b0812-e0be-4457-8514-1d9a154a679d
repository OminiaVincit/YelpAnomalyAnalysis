...
class LogPlot(object):
    ...
    def setup_figure(self):
        ...
        self.ax_perf_l = self.fig.add_subplot(1, 1, 1)
    ...
    def update_log(self, log, items):
        ...
        self.ax_perf_r.set_ylim(0.5, self.ax_perf_r.get_ylim()[1])
        self.ax_perf_r.set_yticks(np.arange(0.5, 1.01, 0.02))
        ...
        self.ax_perf_l.legend(lines_upper, [l.get_label() for l in lines_upper], loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=4)
        ...
        if True:
            ...
            if args and getattr(args, 'site', None):
                text_lines.append('site = {}, index = {}, norm = {}'.format(args.site, args.index, args.norm))
